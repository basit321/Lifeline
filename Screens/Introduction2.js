...
User will Face 2 Face record time See what
exciting experience could happen in 60 
seconds
</Text>
...
<TouchableOpacity style={{...styles.Button}}  activeOpacity={1} onPress={()=>navigation.navigate('Introduction3')}>
