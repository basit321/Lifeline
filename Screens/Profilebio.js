...
<Text style={{fontFamily:"mulishLight",fontSize:14,color:"#2B3A52"}}>
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam 
condimentum praesent nunc, habitasse. Dolor feugiat tellus orci, 
curabitur duis. Morbi accumsan, non egestas faucibus erat cursus 
morbi. Vivamus nec ullamcorper cras dapibus eget.

Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam 
condimentum praesent nunc, habitasse.
</Text>
...
Personal Infomation
    ...
    <Text style={{fontFamily:"mulishLight",fontSize:14,color:"#5E5EC3",}}>
...
<Box style={{width:width*0.9,height:44,borderWidth:1,borderColor:"#E0E0E0"}} mt='5%' >

<HStack my='auto' width='90%' mx='auto' justifyContent='space-between'>

<Text style={{fontFamily:"mulishLight",fontSize:14,color:"#434242"}}>
...
<TouchableOpacity style={{...styles.Button,marginTop:"10%",width:width*0.6,marginLeft:"auto",marginRight:"auto"}} activeOpacity={1} 
